...
- **Industrial-grade evaluation benchmark** : Different from conventional metric-only evaluation schemes, our proposed benchmark integrates a complete evaluation framework and high-quality dataset, focusing on practical delivery standards rather than simple text similarity, achieving comprehensive and credible assessment of subtitle translation quality.
